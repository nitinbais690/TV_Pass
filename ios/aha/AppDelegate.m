...
// Removing Flipper because of this: https://github.com/react-native-community/upgrade-support/issues/79
...
//  castStyle.castViews.bodyTextFont = [UIFont fontWithName:@"Inter-Regular" size:14.0];
...
//
//  castStyle.castViews.deviceControl.deviceChooser.backgroundColor = [UIColor colorWithRed: 0.07 green: 0.07 blue: 0.07 alpha: 1.00];
//  castStyle.castViews.deviceControl.deviceChooser.headingTextColor = [UIColor whiteColor];
//  castStyle.castViews.deviceControl.deviceChooser.headingTextFont = [UIFont fontWithName:@"Inter-Regular" size:16.0];
...
//  castStyle.castViews.deviceControl.headingTextFont = [UIFont fontWithName:@"Inter-Light" size:16.0];
//  castStyle.castViews.deviceControl.bodyTextColor = [UIColor whiteColor];
//  castStyle.castViews.deviceControl.bodyTextFont = [UIFont fontWithName:@"Inter-Regular" size:16.0];
//  castStyle.castViews.deviceControl.headingTextColor = [UIColor whiteColor];
//
//  castStyle.castViews.mediaControl.headingTextColor = [UIColor whiteColor];
//  castStyle.castViews.mediaControl.headingTextFont = [UIFont fontWithName:@"Inter-Light" size:16.0];
//  castStyle.castViews.mediaControl.bodyTextColor = [UIColor whiteColor];
//  castStyle.castViews.mediaControl.bodyTextFont = [UIFont fontWithName:@"Inter-Regular" size:16.0];
//
//  castStyle.castViews.deviceControl.connectionController.backgroundColor = [UIColor colorWithRed: 0.07 green: 0.07 blue: 0.07 alpha: 1.00];
...
//  castStyle.castViews.deviceControl.connectionController.navigation.headingTextFont = [UIFont fontWithName:@"Inter-Light" size:16.0];
...
//  castStyle.castViews.deviceControl.connectionController.navigation.backgroundColor = [UIColor colorWithRed:0.17 green:0.17 blue:0.17 alpha:1.00]; // #2C2C2C - primaryVariant1
